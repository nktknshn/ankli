...
parser.add_argument("fields_name", type=str, help="field name")
...
def handle_script(acol: ankicol.AnkiCollection, args: Any):
    ...
    print(f"field name: {args.fields_name}")

    # nt_id = notes.NotetypeId(1729533187747)

    # note_type = acol.get_note_types([nt_id])[0]

    # field1 = acol.col.models.new_field("D")
